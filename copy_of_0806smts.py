...
print("🚦 Signal Strategy:", signal_duration)

# Commented out IPython magic to ensure Python compatibility.
# 🚦 Smart Traffic Signal System with Images + Weather Integration
...
print(f"🚦 Signal Strategy: {signal_strategy}")
...
print(f"\n🚦 Updated Traffic Signal Timings (Two Phases Green):")
for pair in phase_pairs:
    ...
    print(f"\n🔁 {p1} & {p2} GREEN")
    print(f"🟢 GREEN: {green_time}s")
    print(f"🟡 YELLOW: {yellow_time}s")
    print(f"🔴 RED: {red_time}s for others")

    print(f"✅ GREEN ON: {p1} + {p2}")
...
# Commented out IPython magic to ensure Python compatibility.
# 🚦 Smart Traffic Signal System with Emergency Vehicle Detection (CNN + OCR + Debug)
...
def emergency_vehicle_classifier(crop_img):
    print("🔍 Checking vehicle crop...")
    if cnn_emergency_classifier(crop_img):
        print("✅ CNN: Detected ambulance")
        return True
    if ocr_emergency_classifier(crop_img):
        print("✅ OCR: Detected ambulance text")
        return True
    ...
    for i, det in enumerate(results.pred[0]):
        ...
        if int(cls_id) in [2, 3, 5, 7]:
            ...
            if emergency_vehicle_classifier(crop_bgr):
                ...
                print(f"🚨 Emergency vehicle detected in {phase}")
                break
...
if emergency_detected_phases:
    print(f"\n🚨 Emergency Detected in: {', '.join(emergency_detected_phases)}")
    for phase in emergency_detected_phases:
        print(f"\n✅ GREEN for Emergency Phase: {phase}")
        print(f"🟢 GREEN: {e_merg_timer}s")
        time.sleep(2)
        print("🟡 YELLOW ON")
        time.sleep(1)
        print("🔴 RED ON")
    print("\n⏭️ Resuming Normal Cycle...\n")
